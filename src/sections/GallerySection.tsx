...
export function GallerySection({ cms }: { cms: CmsData }) {
  ...
  return (
    <Section id="gallery">
      ...
      >
        <h2 className="mb-8 font-display text-center leading-tight tracking-tight text-min-text md:text-5xl" style={{ fontSize: 'clamp(2rem, 5vw, 3.5rem)', fontWeight: 900, letterSpacing: '-0.03em' }}>
          Галерея
        </h2>

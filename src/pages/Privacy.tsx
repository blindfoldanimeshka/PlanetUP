  ...
  return (
    <>
      ...
      <main className="mx-auto max-w-3xl px-4 py-16">
        <h1 className="text-3xl font-bold text-light-text">Политика конфиденциальности</h1>
        <p className="mt-2 text-sm text-light-muted">
          Действует с 1 августа 2026 г.
        </p>

        <section className="mt-8">
          <h2 className="text-xl font-semibold text-light-text">1. Оператор персональных данных</h2>
          <p className="mt-2 text-light-text leading-relaxed">
        ...
        <section className="mt-6">
          <h2 className="text-xl font-semibold text-light-text">2. Цели обработки персональных данных</h2>
          <p className="mt-2 text-light-text leading-relaxed">
            Мы обрабатываем персональные данные исключительно для:
          </p>
          <ul className="mt-2 list-disc pl-5 text-light-text leading-relaxed">
        ...
        <section className="mt-6">
          <h2 className="text-xl font-semibold text-light-text">3. Категории обрабатываемых персональных данных</h2>
          <p className="mt-2 text-light-text leading-relaxed">
        ...
        <section className="mt-6">
          <h2 className="text-xl font-semibold text-light-text">4. Сроки хранения и порядок уничтожения</h2>
          <p className="mt-2 text-light-text leading-relaxed">
        ...
        <section className="mt-6">
          <h2 className="text-xl font-semibold text-light-text">5. Права субъекта персональных данных</h2>
          <p className="mt-2 text-light-text leading-relaxed">
        ...
        <section className="mt-6">
          <h2 className="text-xl font-semibold text-light-text">6. Контакты для обращений по вопросам ПД</h2>
          <p className="mt-2 text-light-text leading-relaxed">
        ...
        <section className="mt-6">
          <h2 className="text-xl font-semibold text-light-text">7. Передача данных третьим лицам</h2>
          <p className="mt-2 text-light-text leading-relaxed">
        ...
        <section className="mt-6">
          <h2 className="text-xl font-semibold text-light-text">8. Использование cookies и аналитики</h2>
          <p className="mt-2 text-light-text leading-relaxed">
        ...
        <a href="/" className="mt-10 inline-block font-medium text-cosmic-accent hover:underline">
          ← На главную
        </a>
      </main>
    </>
